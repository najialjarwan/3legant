...
export const PRODUCTS = {
    ...
    BAMBOO_BASKET: {
        ...
        description: 'Super-soft cushion cover in off-white with a tactile pattern that enhances the different tones in the pile and base.',
        categories: [
            SHOP_CATEGORIES_ITEMS.DINNING,
            SHOP_CATEGORIES_ITEMS.OUTDOOR,
        ],
        additionalInfo: [
            {
                label: 'details',
        ...
        image: '/images/products/bamboo-basket/bamboo basket beige.png',
        gallery: [
            '/images/products/bamboo-basket/bamboo basket beige.png',
            '/images/products/bamboo-basket/bamboo basket beige.png',
            '/images/products/bamboo-basket/bamboo basket beige.png',
            '/images/products/bamboo-basket/bamboo basket beige.png',
            '/images/products/bamboo-basket/bamboo basket beige.png',
    ...
    LIGHT_DRAWER_UNIT: {
        ...
        description: 'Super-soft cushion cover in off-white with a tactile pattern that enhances the different tones in the pile and base.',
        categories: [
            SHOP_CATEGORIES_ITEMS.BATHROOM,
        ],
        additionalInfo: [
            {
                label: 'details',
    ...
    COZY_SOFA: {
        ...
        image: '/images/products/cozy-sofa/cozy sofa beige.png',
        gallery: [
            '/images/products/cozy-sofa/cozy sofa beige.png',
            '/images/products/cozy-sofa/cozy sofa beige.png',
            '/images/products/cozy-sofa/cozy sofa beige.png',
            '/images/products/cozy-sofa/cozy sofa beige.png',
            '/images/products/cozy-sofa/cozy sofa beige.png',
